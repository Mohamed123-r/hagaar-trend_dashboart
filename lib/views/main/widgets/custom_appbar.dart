        ...
        child: Row(
          children: [
            widget.showBack == true
                ...
                : SizedBox(),
            widget.showBack == true ? SizedBox(width: 24) : SizedBox(),
            Text(widget.title, style: AppTextStyles.style28W700(context)),
            Spacer(),
      ...
      leading: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Icon(Icons.circle, color: AppColors.greenWhite, size: 14),
          ),
        ],
      ),
      title: Text(name, style: AppTextStyles.style16W400(context)),
      subtitle: Text(phone, style: AppTextStyles.style16W400(context)),
      trailing: Text(
        date,
