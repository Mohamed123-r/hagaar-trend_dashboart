...
class CustomerDealsSection extends StatelessWidget {
  const CustomerDealsSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("صفقات العميل:", style: AppTextStyles.style24W700(context)),
                ...
                return InkWell(
                  onTap: () {
                    showDialog(
                      context: context,
                      builder:
                          (context) => DealDetailsDialog(direction: direction),
                    );
                  },
                  borderRadius: BorderRadius.circular(32),
...
class DealDetailsDialog extends StatelessWidget {
  ...
  const DealDetailsDialog({super.key, required this.direction});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Spacer(),
          Text(value, style: AppTextStyles.style16W400(context)),
        ],
      ),
    );
  }
          ...
          SizedBox(
            child: Row(
              ...
              children: [
                ...
                Text(value1, style: AppTextStyles.style16W400(context)),
              ],
            ),
          ),
        ],
